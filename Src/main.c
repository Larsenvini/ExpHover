...
} __attribute__((packed)) lalalalalalal ;

lalalalalalal sendlala;
  ...
  while(1) {
    ...
    // ####### DEBUG SERIAL OUT #######
      ...
      if (main_loop_counter % 25 == 0) {    // Send data periodically every 125 ms      
          ...
          sendlala.startFrame = 0xaaaa;
          sendlala.sendlala1 = left_dc_curr;
          sendlala.sendlala2 = right_dc_curr;
          // sendlala.endch = '\0';
          

         // printf("%s", (char*)&sendlala);
          // char sendlalalalalalalalabuf[] = {(char)228, (char)0, (char)229, (char)0, '\0'};
          // sendlalalalalalalalabuf[0] = 228;
          // sendlalalalalalalalabuf[1] = 0;
          // sendlalalalalalalalabuf[2] = 229;
          // sendlalalalalalalalabuf[3] = 0;
          // sendlalalalalalalalabuf[4] = '\0';
          // strcpy(sendlalalalalalalalabuf, (char*)&sendlala);
            printf("%c%c%c%c%c%c\r\n", sendlala.startFrame, (sendlala.startFrame >> 8), sendlala.sendlala1 & 0xFF, (sendlala.sendlala1 >> 8) & 0xFF, sendlala.sendlala2 & 0xFF, (sendlala.sendlala2 >> 8) & 0xFF);
          //  printf("in1:%i in2:%i cmdL:%i cmdR:%i BatADC:%i BatV:%i TempADC:%i Temp:%i x:%s\r\n",
          //   input1[inIdx].raw,        // 1: INPUT1
          //   input2[inIdx].raw,        // 2: INPUT2
          //   cmdL,                     // 3: output command: [-1000, 1000]
          //   cmdR,                     // 4: output command: [-1000, 1000]
          //   adc_buffer.batt1,         // 5: for battery voltage calibration
          //   left_dc_curr,         // 6: for verifying battery voltage calibration
          //   right_dc_curr,       // 7: for board temperature calibration
          //   board_temp_deg_c,
          //   sendlalalalalalalalabuf);        // 8: for verifying board temperature calibration
